	      ...
	      for(int i=0;i<matrixSorted.length;i++){
	    	  ...
	    	  if(i<matrixSorted.length-1 && isLap(matrixSorted[i], matrixSorted[i+1])){
	    		  if(couple=='J'){
	    			  ...
	    			  couple=getcouple(couple);
	    			  
	    			  if(!cStack.isEmpty() && isLap(cStack.peek(),matrixSorted[i+1])){
	    				  isImpossible=true;
	    				  break;
	    			  }
	    		  }else{
	    			  ...
	    			  if(!JStack.isEmpty() && isLap(JStack.peek(), matrixSorted[i+1])){
	    				  isImpossible=true;
	    				  break;
	    			  }
	    		  }
